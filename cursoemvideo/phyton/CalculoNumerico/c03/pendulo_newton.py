...
suporte1=cylinder(pos=vector(-6,10,0), radius=0.2, axis=vector(0,0,2))
suporte2=cylinder(pos=vector(6,10,0), radius=0.2, axis=vector(0,0,2))
suporte3=cylinder(pos=vector(-2,10,0), radius=0.2, axis=vector(0,0,2))
suporte4=cylinder(pos=vector(2,10,0), radius=0.2, axis=vector(0,0,2))
#fio1=curve(pos=vector[(suporte1.pos),(bola1.pos)])
