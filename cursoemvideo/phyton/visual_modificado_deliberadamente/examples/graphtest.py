...
for t in arange(-30, 74, 1):
    funct1.plot( pos=vector(t, 5.0+5.0*cos(-0.2*t)*exp(0.015*t)) )
    funct2.plot( pos=vector(t, 2.0+5.0*cos(-0.1*t)*exp(0.015*t)) )
    funct3.plot( pos=vector(t, 5.0*cos(-0.03*t)*exp(0.015*t)) )
