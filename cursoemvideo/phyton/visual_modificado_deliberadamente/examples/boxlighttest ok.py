...
b1 = sphere(radius=0.3, pos=vector(r, 0, 0),
            color=color.magenta, texture=textures.wood)
b2 = sphere(radius=0.3, pos=vector(0, 0, r),
            color=color.yellow, texture=textures.wood)
b3 = arrow(radius=0.3, pos=vector(0, 0, r),
            color=color.green, texture=textures.wood)
