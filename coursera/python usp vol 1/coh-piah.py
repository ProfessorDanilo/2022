...
def n_palavras_unicas(lista_palavras):
    '''Essa função recebe uma lista de palavras e devolve o numero de palavras que aparecem uma unica vez'''
    freq = dict()
    unicas = 0
...
# Essa função recebe uma lista de textos e deve devolver o numero (1 a n) do texto com maior probabilidade de ter sido infectado por COH-PIAH.
...
# Calcula a media do numero de caracteres por palavra
...
# Calcula Numero palavras utilizadas
def calcula_Hapax_Legomana(palavras):
    numPalavasUnicas = n_palavras_unicas(palavras)   
    return numPalavasUnicas / len(palavras)
    
    
# Media simples do nmro de caracteres por sentensa, sem os caracteres delimitadores
...
# numero total de frases divido pelo número de sentenças
